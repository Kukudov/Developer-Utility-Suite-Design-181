        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full h-32 bg-slate-700/50 border border-slate-600 rounded-lg p-4 text-white text-sm resize-none focus:outline-none focus:border-purple-500 transition-colors"
            />
            <button
              onClick={processText}
